...
const conversations = [
  { id: 1, name: 'Kenya Insurance HQ', role: 'Insurer', lastMessage: 'Please prioritize claim #1002', time: '10:30 AM', unread: 2 },
  { id: 2, name: 'Mary Wanjiku', role: 'Insured', lastMessage: 'Thank you for visiting today', time: '9:45 AM', unread: 0 },
  { id: 3, name: 'Ali Hassan', role: 'Insured', lastMessage: 'When will you arrive?', time: 'Yesterday', unread: 1 },
  { id: 4, name: 'James Mwangi', role: 'Insured', lastMessage: 'I have the documents ready', time: 'Yesterday', unread: 0 },
  { id: 5, name: 'Claims Department', role: 'Insurer', lastMessage: 'Report approved for #1004', time: 'Dec 3', unread: 0 },
];

const messages = [
  { id: 1, sender: 'Kenya Insurance HQ', content: 'Good morning! We have a high priority claim in Kilimani.', time: '10:15 AM', isMe: false },
  { id: 2, sender: 'Me', content: 'Good morning. I can visit today at 10 AM.', time: '10:20 AM', isMe: true },
  { id: 3, sender: 'Kenya Insurance HQ', content: 'Perfect. The insured is Mary Wanjiku. Fire damage case.', time: '10:25 AM', isMe: false },
  { id: 4, sender: 'Kenya Insurance HQ', content: 'Please prioritize claim #1002', time: '10:30 AM', isMe: false },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Communicate with insurers and policyholders</p>
      </div>
